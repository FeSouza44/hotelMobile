...
const style = StyleSheet.create({
  cardContainer: {
    ...
    mainLabel: { fontSize: 20, fontWeight: '700', color: '#000000a8', marginBottom: 5 },
    ...
    price: { fontSize: 18, fontWeight: 'bold', color: "#6e0e0e" },
    reserveButton: {
    backgroundColor: '#530f23',
    paddingVertical: 12,
    borderRadius: 12,
    alignItems: 'center',
    marginTop: 5
  },
  reserveButtonText: { color: '#ffffff', fontWeight: '700', fontSize: 16 }
});
